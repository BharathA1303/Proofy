...
class TestNationalIdProfile:
    def test_national_id_profile_configuration(self):
        ...
        assert profile.document_type in ("aadhaar", "national_id")
        assert profile.display_name in ("Aadhaar Card", "National ID")
        ...
        assert "docNumber" in profile.field_schema or "identity_number" in profile.field_schema
    ...
    def test_resolve_national_id_aliases(self):
        for alias in ["nationalId", "nationalid", "national_id", "nid", "aadhaar"]:
            ...
            assert resolved.document_type in ("aadhaar", "national_id")
    ...
    def test_resolve_operational_national_id(self):
        ...
        assert operational.document_type in ("aadhaar", "national_id")
